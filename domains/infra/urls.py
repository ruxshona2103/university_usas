...
from .views import (
    SportMajmuaListAPIView, SportMajmuaDetailAPIView,
    SharoitListAPIView, SportMajmuaRecordViewAPIView,
    OlimpiyaInfoAPIView,
)
...
urlpatterns = [
    ...
    path('infra/olimpiya-shaharchasi/',            OlimpiyaInfoAPIView.as_view(),          name='olimpiya-info'),
]

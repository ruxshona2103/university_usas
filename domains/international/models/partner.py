...
class PartnerOrganization(TimeStampedModel):
    ...
    logo  = models.FileField(upload_to='partners/logos/', blank=True, verbose_name="Logo")
    image = models.FileField(upload_to='partners/images/', blank=True, verbose_name="Rasm")

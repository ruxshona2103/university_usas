...
class MagistrTalaba(TimeStampedModel):
    ...
    full_name_uz = models.CharField(max_length=300, blank=True, verbose_name="F.I.Sh. (Uz)")
    full_name_ru = models.CharField(max_length=300, blank=True, verbose_name="F.I.Sh. (Ru)")
    full_name_en = models.CharField(max_length=300, blank=True, verbose_name="F.I.Sh. (En)")
    ...
    supervisor_name_uz = models.CharField(max_length=300, blank=True, verbose_name="Ilmiy rahbar F.I.Sh. (Uz)")
    supervisor_name_ru = models.CharField(max_length=300, blank=True, verbose_name="Ilmiy rahbar F.I.Sh. (Ru)")
    supervisor_name_en = models.CharField(max_length=300, blank=True, verbose_name="Ilmiy rahbar F.I.Sh. (En)")
    ...
    class Meta:
        ...
        ordering            = ['year', 'order', 'full_name_uz']
        verbose_name        = "Magistratura talabasi (yangi)"
        verbose_name_plural = "Magistratura talabalari (yangi)"

    def __str__(self):
        name = self.full_name_uz or (self.person.full_name_uz if self.person_id else '—')

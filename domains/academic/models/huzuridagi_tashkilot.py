...
class HuzuridagiTashkilot(TimeStampedModel):
    ...
    image          = models.ImageField(upload_to=tashkilot_image_upload, blank=True, null=True, verbose_name="Rasm (Uz)")
    image_ru       = models.ImageField(upload_to=tashkilot_image_upload, blank=True, null=True, verbose_name="Rasm (Ru)")
    image_en       = models.ImageField(upload_to=tashkilot_image_upload, blank=True, null=True, verbose_name="Rasm (En)")

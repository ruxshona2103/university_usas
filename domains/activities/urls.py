...
from .views import (
    ...
    IlmiyFaoliyatCategoryDetailAPIView,
...
urlpatterns = [
    ...
    path('activities/faoliyat/categories/<slug:slug>/',IlmiyFaoliyatCategoryDetailAPIView.as_view(),name='faoliyat-category-detail'),

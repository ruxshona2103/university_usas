    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_type', models.CharField(choices=[('news', 'Yangilik'), ('event', 'Tadbir'), ('blog', 'Blog')], db_index=True, max_length=10, verbose_name='Tur')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['content_type', 'is_published'], name='news_inform_content_f79348_idx')],
            },
        ),
        migrations.CreateModel(
            name='Briefing',
